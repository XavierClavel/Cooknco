...
object FrStrings : Strings {
    ...
    override val addToCookbook = "Ajouter à un carnet de recette"
    ...
    override val deleteRecipeWarning =
        "C'est définitif. La recette quitte tous les carnets de recette où elle se trouve."
    ...
    override val cookbooks = "Carnets de recette"
    ...
    override val deleteAccountMessage = "Vos recettes, leurs photos, vos notes privées et le compte lui-même disparaissent, immédiatement. C'est irréversible — exportez d'abord ce que vous voulez garder."
    override val deleteAccountConfirm = "Supprimer définitivement"
    override val deleteAccountFailed = "Le compte n'a pas pu être supprimé. Réessayez, ou écrivez à contact@cooknco.eu."
    ...
    override val noCookbooksYet =
        "Vous n'avez pas encore de carnet de recette. Créez-en un depuis l'onglet Carnets."
    override val done = "Terminé"
    override val editCookbook = "Modifier le carnet de recette"
    ...
    override fun deleteCookbookMessage(members: Int, recipes: Int): String {
        ...
        return "Le carnet de recette disparaît pour ses $memberPart. $recipePart à leur place."
    }

    override val deleteCookbook = "Supprimer le carnet de recette"
    override fun addedBy(name: String) = "Ajoutée par $name"
    override val you = "Vous"
    override val admin = "Admin"
    override val cookbookPhoto = "Photo du carnet de recette"
    ...
    override val cookbooksCaps = "CARNETS DE RECETTE"
    ...
    override val usedInThisStep = "UTILISÉ DANS CETTE ÉTAPE"
    override val stepTimerPlaceholder = "--"
    override val addToStep = "Ajouter"
    override val stepIngredientsLabel = "Ingrédients"
    override val removeStepIngredients = "Retirer les ingrédients"
    override val noIngredientsToPickYet = "Ajoutez d'abord les ingrédients de la recette, puis choisissez-les ici."
    override val removeStepTimer = "Supprimer le minuteur"
    override val stepPhotoLabel = "Photo"
    override val removeStepPhoto = "Supprimer la photo"
    override val recipeStepPhoto = "Photo de l'étape"
    ...
    override val importCooklangHint = "Remplit le formulaire à partir d'un fichier .cook. Rien de ce qui est déjà saisi n'est remplacé."
