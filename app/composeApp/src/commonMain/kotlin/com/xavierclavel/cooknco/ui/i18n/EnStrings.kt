...
object EnStrings : Strings {
    ...
    override val deleteAccountMessage = "Your recipes, their photos, your private notes and the account itself go, straight away. This cannot be undone — export anything you want to keep first."
    override val deleteAccountConfirm = "Delete for ever"
    override val deleteAccountFailed = "The account could not be deleted. Try again, or write to contact@cooknco.eu."
    ...
    override val usedInThisStep = "USED IN THIS STEP"
    override val stepTimerPlaceholder = "--"
    override val addToStep = "Add"
    override val stepIngredientsLabel = "Ingredients"
    override val removeStepIngredients = "Remove the ingredients"
    override val noIngredientsToPickYet = "Add the recipe's ingredients first, then pick them here."
    override val removeStepTimer = "Remove timer"
    override val stepPhotoLabel = "Photo"
    override val removeStepPhoto = "Remove photo"
    override val recipeStepPhoto = "Step photo"
